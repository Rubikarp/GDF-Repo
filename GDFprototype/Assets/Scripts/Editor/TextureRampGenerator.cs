...
namespace Karprod
{
    ...
    public static class TextureRamp
    {
        ...
        public static void Create(Gradient grd, string name, string filePath)
        {
            //generate the path
            string path = filePath + name + ".png";
        ...
        public static void Create(Gradient grd, string name, string filePath, int width, int height)
        {
            //generate the path
            string path = filePath + name + ".png";

            //Creating The texture
            Texture2D texture = Generate(grd, width, height);
